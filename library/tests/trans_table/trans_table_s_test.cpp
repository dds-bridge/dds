...
TEST(TransTableSStatsTest, GetOpStatsReturnsSentinelValues)
{
    TransTableS tt;
    int adds = 0, overwrites = 0, harvests = 0;
...
TEST(TransTableSStatsTest, ResetOpStatsDoesNotChangeSentinels)
{
    TransTableS tt;
    tt.reset_op_stats();
    int adds = 0, overwrites = 0, harvests = 0;
