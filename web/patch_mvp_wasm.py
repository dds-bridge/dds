...
`//web:dds_mvp_wasm` and run this script; if the regex no longer matches,
...
def main() -> int:
    ...
    if not matches:
        print(
            "patch_mvp_wasm: isFileURI declaration not found "
            f"(expected Emscripten output from emsdk BCR {EXPECTED_EMSDK_BAZEL_DEP_VERSION}).\n"
            "After upgrading emsdk, rebuild //web:dds_mvp_wasm and update "
