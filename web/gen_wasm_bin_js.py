#!/usr/bin/env python3
"""Emit dds_web_wasm_bin.js with base64-encoded wasm for file:// and HTTP."""
...
def make_bin_js(wasm_bytes: bytes) -> str:
    """Return the contents of dds_web_wasm_bin.js for the given wasm module."""
    b64 = base64.b64encode(wasm_bytes).decode("ascii")
    lines = [b64[i : i + 76] for i in range(0, len(b64), 76)]
    body = 'const DDS_WEB_WASM_BASE64 =\n    "' + '" +\n    "'.join(lines) + '";\n\n'
    return HEADER + body
